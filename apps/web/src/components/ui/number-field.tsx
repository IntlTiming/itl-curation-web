...
const numberFieldButtonVariants = cva(
  "relative flex shrink-0 cursor-pointer items-center justify-center transition-colors hover:bg-accent",
  {
    variants: {
      size: {
        sm: "px-1.5 [&_svg:not([class*='size-'])]:size-3",
        default: "px-2 [&_svg:not([class*='size-'])]:size-3.5",
        lg: "px-2.5 [&_svg:not([class*='size-'])]:size-3.5",
      },
    },
    defaultVariants: {
      size: "default",
